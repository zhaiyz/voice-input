...
本项目基于 [yetone/voice-input-src](https://github.com/yetone/voice-input-src) 项目需求文档，通过以下工具和技术自动生成：

- **开发工具**: [OpenCode](https://opencode.ai) - AI 辅助编程工具
- **生成模型**: GLM-5 / Qwen3.6-Plus
- **生成日期**: 2025年4月5日

项目从零开始，完整实现了需求文档中的所有功能，包括：
- 全局 Fn 键监听
- 设备端语音识别
- 实时波形动画
- LLM 文本精炼
